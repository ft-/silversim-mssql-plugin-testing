...
{
    public static class MsSqlInventoryExtensionMethods
    {
        public static InventoryFolder ToFolder(this SqlDataReader reader) => new InventoryFolder(reader.GetUUID("ID"))
        {
        ...
        public static InventoryItem ToItem(this SqlDataReader reader)
        {
