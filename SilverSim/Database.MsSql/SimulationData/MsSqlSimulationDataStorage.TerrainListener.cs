...
namespace SilverSim.Database.MsSql.SimulationData
{
    ...
    {
        readonly RwLockedList<MsSqlTerrainListener> m_TerrainListenerThreads = new RwLockedList<MsSqlTerrainListener>();
        public class MsSqlTerrainListener : TerrainListener
        {
            private readonly RwLockedList<MsSqlTerrainListener> m_TerrainListenerThreads;
            private readonly string m_ConnectionString;

            public MsSqlTerrainListener(string connectionString, UUID regionID, RwLockedList<MsSqlTerrainListener> terrainListenerThreads)
            {
        ...
        public override TerrainListener GetTerrainListener(UUID regionID) =>
            new MsSqlTerrainListener(m_ConnectionString, regionID, m_TerrainListenerThreads);
    }
}
